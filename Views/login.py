...
class LoginPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Vui lòng xác thực quyền truy cập để xem dữ liệu chi tiêu", font=("Arial", 14, "italic"),
                 fg="#7f8c8d", bg="#F5F5F5").pack(pady=(0, 50))

        tk.Label(self, text="Tên đăng nhập:", font=("Arial", 13), bg="#F5F5F5").pack(pady=(5, 4))
        self.u_ent = tk.Entry(self, width=35, font=("Arial", 14))
        ...
        tk.Button(self, text="ĐĂNG NHẬP 🔓", bg="#2196F3", fg="white", font=("Arial", 14, "bold"), width=22, height=2,
                  command=self.handle_login).pack(pady=40)
