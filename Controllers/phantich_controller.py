...
class PhanTich_Controller:
    ...
    def load_data_and_draw_chart(self):
        ...
        # 1. Đọc giá trị bộ lọc từ các Combobox trên giao diện View
        ...
        # 4. Xóa biểu đồ cũ để tránh vẽ đè
        for widget in self.view.chart_frame.winfo_children():
            widget.destroy()

        # 5. Khởi tạo và vẽ biểu đồ tròn Matplotlib
        fig, ax = plt.subplots(figsize=(6, 4), dpi=100)

        if tong_thu == 0 and tong_chi == 0:
            # Thông báo khi tháng/năm đó chưa có dữ liệu giao dịch nào
            ...
            # Đổi tiêu đề linh hoạt theo mốc thời gian lọc
        ...
        # 6. Đẩy đồ thị canvas vào khung Tkinter
